...
public class ActiniumBowItem extends Item {
	public ActiniumBowItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ActiniumBowEntity entityarrow = ActiniumBowEntity.shoot(world, entity, world.getRandom(), 1f, 4, 3);
